...
public class HttpServletServiceTracker extends ServiceTracker {
    ...
    public Object addingService(ServiceReference reference) {
    	...
    	if(url !=null && !url.isEmpty()){
	        ...
	        System.out.println("WebApp1 got new HttpServlet with url (" + url + "). Going add it to list");
    	}
    ...
    public void removedService(ServiceReference reference, Object service) {
    	String url = (String) reference.getProperty("url");
        System.out.println("WebApp1 got HttpServlet (" + url + ") be removed. Going remove it to list");
